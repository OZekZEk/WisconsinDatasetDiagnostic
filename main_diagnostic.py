...
def split_data_same_percentage(data_frame):
    data_frame_benign = data_frame[data_frame.iloc[:, 1]=="B"]
    data_frame_malignant = data_frame[data_frame.iloc[:, 1]=="M"]
    ...
    train_data_frame.iloc[train_data_frame.iloc[:, 1]=="B", 1]="benign"
    train_data_frame.iloc[train_data_frame.iloc[:, 1]=="M", 1]="malignant"

    test_data_frame.iloc[test_data_frame.iloc[:, 1]=="B", 1]="benign"
    test_data_frame.iloc[test_data_frame.iloc[:, 1]=="M", 1]="malignant"
